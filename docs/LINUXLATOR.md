...
Bastille suporta a criação de templates e Jails rodando um *userland* Linux. Dessa forma, podemos manter o "Clean Host" e ainda obter 100% de flexibilidade de desenvolvimento.
